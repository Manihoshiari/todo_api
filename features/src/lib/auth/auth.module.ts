...
import { authcornService } from './authcron.service';
@Module({
  imports: [
    TypeOrmModule.forFeature([TestUser, tasksEntity, tokensEntity]),
    PassportModule.register({ defaultStrategy: 'jwt' }),
    JwtModule.register({}),
  ],
  providers: [AuthService, JwtStrategy, JwtRefreshStrategy,authcornService],
